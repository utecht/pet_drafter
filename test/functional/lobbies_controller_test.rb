...
class LobbiesControllerTest < ActionController::TestCase
  ...
  test "should create lobby" do
    assert_difference('Lobby.count') do
      post :create, lobby: { accepted: @lobby.accepted, challengetime: @lobby.challengetime, time: @lobby.time }
    end
  ...
  test "should update lobby" do
    put :update, id: @lobby, lobby: { accepted: @lobby.accepted, challengetime: @lobby.challengetime, time: @lobby.time }
    assert_redirected_to lobby_path(assigns(:lobby))
  end
